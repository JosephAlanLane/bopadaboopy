...
export function SubscriptionButton() {
  ...
  return (
    <Button 
      ...
      variant="ghost"
      className="border border-gray-200 dark:border-gray-700 text-foreground hover:bg-[linear-gradient(-45deg,#008C45_25%,#F4F9FF_50%,#CD212A_75%)] hover:text-gray-700 hover:border-transparent transition-all duration-300"
    >
